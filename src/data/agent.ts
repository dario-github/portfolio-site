...
export const OPENCLAW_SKILLS = [
  { name: "1password", desc: "1Password CLI 密钥管理" },
  ...
  { name: "deep-think", desc: "Gemini + GPT 深度推理（多模型交叉验证 + think tool）" },
  { name: "drawio", desc: "流程图/架构图自动生成" },
  { name: "feishu-doc", desc: "飞书文档读写" },
  { name: "gemini-code-execution", desc: "Gemini 代码执行+图片分析" },
  ...
  { name: "gog", desc: "Google Workspace（Gmail/日历/Drive/Sheets/Docs）" },
  { name: "healthcheck", desc: "系统安全巡检" },
  { name: "kox", desc: "KOX 视频创作全链路（Stage8生产/视频生成/图片生成/NLE导出/素材管理）" },
  ...
  { name: "openbb", desc: "美股/加密/外汇/宏观数据" },
  { name: "portfolio-opt", desc: "投资组合优化（最大夏普/最小方差）" },
  { name: "pptx-generator", desc: "PowerPoint 自动生成" },
  { name: "quant-signals", desc: "量化信号分析（均值回归/配对交易）" },
  { name: "research", desc: "Sub-agent 驱动的深度调研" },
  { name: "rss", desc: "RSS 订阅监控" },
  { name: "seo-geo", desc: "SEO + AI 搜索引擎优化" },
  ...
  { name: "talib-analysis", desc: "技术指标分析（MACD/RSI/KDJ/BOLL）" },
  { name: "things-mac", desc: "Things 待办管理" },
  { name: "tikhub", desc: "社媒数据 API（20+平台）" },
  { name: "tts-multi", desc: "商汤/Edge-TTS 多引擎语音合成" },
  { name: "tushare", desc: "A股/港股行情 + 券商研报 + 市场扫描" },
  { name: "video-frames", desc: "视频关键帧提取" },
  { name: "video-summarizer", desc: "视频内容智能摘要" },
  { name: "vml-gen", desc: "Viking Memory 分层生成" },
  { name: "vml-search", desc: "Viking Memory 两阶段检索" },
  { name: "weather", desc: "天气查询" },
  { name: "web-search", desc: "Brave Search API 多引擎搜索 + 结构化摘要" },
  { name: "x-research", desc: "X/Twitter 实时研究" },
];
